# The Solid State Disk Simulator

Welcome to ssd.py, yet another wonderful simulator provided to you, for free,
...
is: the air you breathe, the love you give and receive, and a book about
...
```
Using -C, -F, and -J lets you really see what is happening, step by step,
inside the log-structured simulation.
...
One other set of controls lets you control randomly generated workloads a bit
more precisely. The -P flag lets you control how many reads/writes/trims show
up (probabilistically). For example, using "-P 30/35/35" means that roughly
30% of operations will be reads, 35% writes, and 35% trims.
